        ...
        match s {
            ...
            _ => Err(alloc::format!(
                "Unknown chip {s}. Possible options: esp32, esp32c2, esp32c3, esp32c5, esp32c6, \
                 esp32c61, esp32h2, esp32h4, esp32p4, esp32s2, esp32s3, esp32s31"
            )),
        }
    }
}
impl Chip {
    ...
    pub fn from_cargo_feature() -> Result<Self, &'static str> {
        let all_chips = [
            ...
            ("CARGO_FEATURE_ESP32H4", Self::Esp32h4),
                ...
                if chip.is_some() {
                    return Err(
                        "Expected exactly one of the following features to be enabled: esp32, \
                         esp32c2, esp32c3, esp32c5, esp32c6, esp32c61, esp32h2, esp32h4, esp32p4, \
        ...
        match chip {
            ...
            None => Err(
                "Expected exactly one of the following features to be enabled: esp32, esp32c2, \
                 esp32c3, esp32c5, esp32c6, esp32c61, esp32h2, esp32h4, esp32p4, esp32s2, \
                 esp32s3, esp32s31",
            ),
        }
    }
        ...
        match self {
            Self::Esp32 => Config {
                ...
                symbols: &[
                    ...
                    "soc_cpu_pmp_granularity=\"4\"",
                    "soc_cpu_pmp_granularity_is_set",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_cpu_pmp_granularity=\"4\"",
                    "cargo:rustc-cfg=soc_cpu_pmp_granularity_is_set",
            ...
            Self::Esp32c5 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_swd_watchdog",
                    "cargo:rustc-cfg=soc_cpu_mcause_mask=\"31\"",
                    "cargo:rustc-cfg=soc_cpu_pmp_granularity=\"128\"",
                    "cargo:rustc-cfg=soc_cpu_pmp_granularity_is_set",
                    "cargo:rustc-cfg=soc_has_clock_node_xtal_clk",
                    "cargo:rustc-cfg=soc_clock_node_xtal_clk_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_pll_clk",
            ...
            Self::Esp32h4 => Config {
                ...
                symbols: &[
                    ...
                    "soc_has_clock_node_iomux_function_clock",
                    "soc_clock_node_iomux_function_clock_is_configurable",
                    "soc_has_clock_node_xtal_x2_clk",
                    "soc_has_clock_node_rc_fast_clk",
                    "soc_has_clock_node_xtal32k_clk",
                    "soc_has_clock_node_osc_slow_clk",
                    "soc_has_clock_node_rc_slow_clk",
                    "soc_has_clock_node_rc_slow_d4_clk",
                    "soc_has_clock_node_hp_root_clk",
                    "soc_clock_node_hp_root_clk_is_configurable",
                    "soc_has_clock_node_cpu_clk",
                    "soc_clock_node_cpu_clk_is_configurable",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_clock_node_iomux_function_clock",
                    "cargo:rustc-cfg=soc_clock_node_iomux_function_clock_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_xtal_x2_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_rc_fast_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_xtal32k_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_osc_slow_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_rc_slow_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_rc_slow_d4_clk",
                    "cargo:rustc-cfg=soc_has_clock_node_hp_root_clk",
                    "cargo:rustc-cfg=soc_clock_node_hp_root_clk_is_configurable",
                    "cargo:rustc-cfg=soc_has_clock_node_cpu_clk",
                    "cargo:rustc-cfg=soc_clock_node_cpu_clk_is_configurable",
                ...
                memory_layout: &MemoryLayout {
                    regions: &[
                        (
                            "dram",
                            MemoryRegion {
                                address_range: 0x40810000..0x4084F350,
                            },
                        ),
                        (
                            "dram2_uninit",
                            MemoryRegion {
                                address_range: 0x4084F350..0x4085D350,
                            },
                        ),
                        (
                            "irom",
    ...
    pub fn all_possible_symbols() -> &'static [&'static str] {
        &[
            ...
            "gpio_input_signal_max, \
             values(\"206\",\"100\",\"116\",\"124\",\"189\",\"249\",\"242\",\"255\")",
            ...
            "interrupts_status_registers, values(\"3\",\"2\",\"4\",\"5\",\"6\")",
            ...
            "soc_cpu_pmp_granularity, values(\"4\",\"128\")",
