...
crate::gpio::gpio! {
    ...
    (8, 0, InputOutputAnalogTouch)
    (9, 0, InputOutputAnalogTouch)
    (10, 0, InputOutputAnalogTouch)
    (11, 0, InputOutputAnalogTouch)
    (12, 0, InputOutputAnalogTouch)
    (13, 0, InputOutputAnalogTouch)
    (14, 0, InputOutputAnalogTouch)
...
crate::gpio::touch_into! {
    // (touch_nr, pin_nr, rtc_pin, touch_comb_reg_nr, normal_pin)
     (1, 1, 1, sar_touch_thres1, touch_out_th1 )
     (2, 2, 2, sar_touch_thres2, touch_out_th2 )
     (3, 3, 3, sar_touch_thres3, touch_out_th3 )
     (4, 4, 4, sar_touch_thres4, touch_out_th4 )
     (5, 5, 5, sar_touch_thres5, touch_out_th5 )
     (6, 6, 6, sar_touch_thres6, touch_out_th6 )
     (7, 7, 7, sar_touch_thres7, touch_out_th7 )
     (8, 8, 8, sar_touch_thres8, touch_out_th8 )
     (9, 9, 9, sar_touch_thres9, touch_out_th9 )
     (10, 10, 10, sar_touch_thres10, touch_out_th10 )
     (11, 11, 11, sar_touch_thres11, touch_out_th11 )
     (12, 12, 12, sar_touch_thres12, touch_out_th12 )
     (13, 13, 13, sar_touch_thres13, touch_out_th13 )
     (14, 14, 14, sar_touch_thres14, touch_out_th14 )
}

crate::gpio::touch_common! {
    // (touch_nr, pin_nr, touch_out_reg, meas_field, touch_thresh_reg, touch_thresh_field )
    (1, 1, sar_touch_status1, touch_pad1_data, sar_touch_thres1, touch_out_th1)
    (2, 2, sar_touch_status2, touch_pad2_data, sar_touch_thres2, touch_out_th2)
    (3, 3, sar_touch_status3, touch_pad3_data, sar_touch_thres3, touch_out_th3)
    (4, 4, sar_touch_status4, touch_pad4_data, sar_touch_thres4, touch_out_th4)
    (5, 5, sar_touch_status5, touch_pad5_data, sar_touch_thres5, touch_out_th5)
    (6, 6, sar_touch_status6, touch_pad6_data, sar_touch_thres6, touch_out_th6)
    (7, 7, sar_touch_status7, touch_pad7_data, sar_touch_thres7, touch_out_th7)
    (8, 8, sar_touch_status8, touch_pad8_data, sar_touch_thres8, touch_out_th8)
    (9, 9, sar_touch_status9, touch_pad9_data, sar_touch_thres9, touch_out_th9)
    (10, 10, sar_touch_status10, touch_pad10_data, sar_touch_thres10, touch_out_th10)
    (11, 11, sar_touch_status11, touch_pad11_data, sar_touch_thres11, touch_out_th11)
    (12, 12, sar_touch_status12, touch_pad12_data, sar_touch_thres12, touch_out_th12)
    (13, 13, sar_touch_status13, touch_pad13_data, sar_touch_thres13, touch_out_th13)
    (14, 14, sar_touch_status14, touch_pad14_data, sar_touch_thres14, touch_out_th14)
}
